...
class StackingClassifier:
    ...
    # O modelo StackingClassifier usa um conjunto de modelos para gerar previsões.
    # Estas previsões são depois usadas para treinar outro modelo, o modelo final.
    # O modelo final pode depois ser usado para prever a variável de saída (Y).
